...
tableTasks.push([17,[140, 24, 57, 99, 120, 112, 19, 66, 125, 144, 61, 180, 29, 75, 100, 26, 87, 107, 160, 90, 138, 58, 127, 81, 74, 174, 3, 79, 63, 48, 149]
				,"which is took as base", 57, "twin search",[],0])
tableTasks.push([18,[],"linked to the task 17",57,"Correct Baseline",[],0]);
tableTasks.push([19,[140, 24, 57, 99, 120, 112, 19, 66, 125, 144, 61, 180, 29, 75, 100, 26, 87, 107, 160, 90, 138, 58, 127, 81, 74, 174, 3, 79, 63, 48, 149]
				,"which is took as base", 112, "twin search",[],0])
tableTasks.push([20,[],"linked to the task 19",112,"Correct Baseline",[],0]);
tableTasks.push([21,[140, 24, 57, 99, 120, 112, 19, 66, 125, 144, 61, 180, 29, 75, 100, 26, 87, 107, 160, 90, 138, 58, 127, 81, 74, 174, 3, 79, 63, 48, 149]
				,"which is took as base", 100, "twin search",[],0])
tableTasks.push([22,[],"linked to the task 21",100,"Correct Baseline",[],0]);
tableTasks.push([23,[140, 24, 57, 99, 120, 112, 19, 66, 125, 144, 61, 180, 29, 75, 100, 26, 87, 107, 160, 90, 138, 58, 127, 81, 74, 174, 3, 79, 63, 48, 149]
				,"which is took as base", 58, "twin search",[],0])
tableTasks.push([24,[],"linked to the task 23",58,"Correct Baseline",[],0]);
tableTasks.push([25,[80, 177, 29, 118, 10, 168, 176, 139, 129, 152, 20, 4, 126, 106, 99, 35, 66, 12, 21, 56, 140, 154, 75, 24, 133, 143, 174, 79, 53, 158, 76]
				,"which is took as base",118,"twin search",[],0]);
tableTasks.push([26,[],"linked to the task 25",118,"Correct Baseline",[],0]);
tableTasks.push([27,[80, 177, 29, 118, 10, 168, 176, 139, 129, 152, 20, 4, 126, 106, 99, 35, 66, 12, 21, 56, 140, 154, 75, 24, 133, 143, 174, 79, 53, 158, 76]
				,"which is took as base",106,"twin search",[],0]);
tableTasks.push([28,[],"linked to the task 27",106,"Correct Baseline",[],0]);
tableTasks.push([29,[80, 177, 29, 118, 10, 168, 176, 139, 129, 152, 20, 4, 126, 106, 99, 35, 66, 12, 21, 56, 140, 154, 75, 24, 133, 143, 174, 79, 53, 158, 76]
				,"which is took as base",21,"twin search",[],0]);
tableTasks.push([30,[],"linked to the task 29",21,"Correct Baseline",[],0]);
tableTasks.push([31,[80, 177, 29, 118, 10, 168, 176, 139, 129, 152, 20, 4, 126, 106, 99, 35, 66, 12, 21, 56, 140, 154, 75, 24, 133, 143, 174, 79, 53, 158, 76]
				,"which is took as base",79,"twin search",[],0]);
tableTasks.push([32,[],"linked to the task 31",79,"Correct Baseline",[],0]);
...
tableOrga.push([0,16,17,[5,"Horizon",30]])
tableOrga.push([0,17,18,[]])
tableOrga.push([0,18,19,[5,"Horizon",30]])
tableOrga.push([0,19,20,[]])
tableOrga.push([0,20,21,[5,"Horizon",30]])
tableOrga.push([0,21,22,[]])
tableOrga.push([0,22,23,[5,"Horizon",30]])
tableOrga.push([0,23,24,[]])
tableOrga.push([0,24,25,[5,"Horizon",30]])
tableOrga.push([0,25,26,[]])
tableOrga.push([0,26,27,[5,"Horizon",30]])
tableOrga.push([0,27,28,[]])
tableOrga.push([0,28,29,[5,"Horizon",30]])
tableOrga.push([0,29,30,[]])
tableOrga.push([0,30,31,[5,"Horizon",30]])
tableOrga.push([0,31,32,[]])
...
tableOrga.push([0,48,17,[10,"Horizon",30]])
tableOrga.push([0,49,18,[]])
tableOrga.push([0,50,19,[10,"Horizon",30]])
tableOrga.push([0,51,20,[]])
tableOrga.push([0,52,21,[10,"Horizon",30]])
tableOrga.push([0,53,22,[]])
tableOrga.push([0,54,23,[10,"Horizon",30]])
tableOrga.push([0,55,24,[]])
tableOrga.push([0,56,25,[10,"Horizon",30]])
tableOrga.push([0,57,26,[]])
tableOrga.push([0,58,27,[10,"Horizon",30]])
tableOrga.push([0,59,28,[]])
tableOrga.push([0,60,29,[10,"Horizon",30]])
tableOrga.push([0,61,30,[]])
tableOrga.push([0,62,31,[10,"Horizon",30]])
tableOrga.push([0,63,32,[]])
...
tableOrga.push([1,16,17,[5,"Stratum",30]])
tableOrga.push([1,17,18,[]])
tableOrga.push([1,18,19,[5,"Stratum",30]])
tableOrga.push([1,19,20,[]])
tableOrga.push([1,20,21,[5,"Stratum",30]])
tableOrga.push([1,21,22,[]])
tableOrga.push([1,22,23,[5,"Stratum",30]])
tableOrga.push([1,23,24,[]])
tableOrga.push([1,24,25,[5,"Stratum",30]])
tableOrga.push([1,25,26,[]])
tableOrga.push([1,26,27,[5,"Stratum",30]])
tableOrga.push([1,27,28,[]])
tableOrga.push([1,28,29,[5,"Stratum",30]])
tableOrga.push([1,29,30,[]])
tableOrga.push([1,30,31,[5,"Stratum",30]])
tableOrga.push([1,31,32,[]])
...
tableOrga.push([1,48,17,[10,"Stratum",30]])
tableOrga.push([1,49,18,[]])
tableOrga.push([1,50,19,[10,"Stratum",30]])
tableOrga.push([1,51,20,[]])
tableOrga.push([1,52,21,[10,"Stratum",30]])
tableOrga.push([1,53,22,[]])
tableOrga.push([1,54,23,[10,"Stratum",30]])
tableOrga.push([1,55,24,[]])
tableOrga.push([1,56,25,[10,"Stratum",30]])
tableOrga.push([1,57,26,[]])
tableOrga.push([1,58,27,[10,"Stratum",30]])
tableOrga.push([1,59,28,[]])
tableOrga.push([1,60,29,[10,"Stratum",30]])
tableOrga.push([1,61,30,[]])
tableOrga.push([1,62,31,[10,"Stratum",30]])
tableOrga.push([1,63,32,[]])
...
tableOrga.push([2,48,17,[5,"Horizon",30]])
tableOrga.push([2,49,18,[]])
tableOrga.push([2,50,19,[5,"Horizon",30]])
tableOrga.push([2,51,20,[]])
tableOrga.push([2,52,21,[5,"Horizon",30]])
tableOrga.push([2,53,22,[]])
tableOrga.push([2,54,23,[5,"Horizon",30]])
tableOrga.push([2,55,24,[]])
tableOrga.push([2,56,25,[5,"Horizon",30]])
tableOrga.push([2,57,26,[]])
tableOrga.push([2,58,27,[5,"Horizon",30]])
tableOrga.push([2,59,28,[]])
tableOrga.push([2,60,29,[5,"Horizon",30]])
tableOrga.push([2,61,30,[]])
tableOrga.push([2,62,31,[5,"Horizon",30]])
tableOrga.push([2,63,32,[]])
...
tableOrga.push([3,16,17,[10,"Stratum",30]])
tableOrga.push([3,17,18,[]])
tableOrga.push([3,18,19,[10,"Stratum",30]])
tableOrga.push([3,19,20,[]])
tableOrga.push([3,20,21,[10,"Stratum",30]])
tableOrga.push([3,21,22,[]])
tableOrga.push([3,22,23,[10,"Stratum",30]])
tableOrga.push([3,23,24,[]])
tableOrga.push([3,24,25,[10,"Stratum",30]])
tableOrga.push([3,25,26,[]])
tableOrga.push([3,26,27,[10,"Stratum",30]])
tableOrga.push([3,27,28,[]])
tableOrga.push([3,28,29,[10,"Stratum",30]])
tableOrga.push([3,29,30,[]])
tableOrga.push([3,30,31,[10,"Stratum",30]])
tableOrga.push([3,31,32,[]])
...
tableOrga.push([3,48,17,[5,"Stratum",30]])
tableOrga.push([3,49,18,[]])
tableOrga.push([3,50,19,[5,"Stratum",30]])
tableOrga.push([3,51,20,[]])
tableOrga.push([3,52,21,[5,"Stratum",30]])
tableOrga.push([3,53,22,[]])
tableOrga.push([3,54,23,[5,"Stratum",30]])
tableOrga.push([3,55,24,[]])
tableOrga.push([3,56,25,[5,"Stratum",30]])
tableOrga.push([3,57,26,[]])
tableOrga.push([3,58,27,[5,"Stratum",30]])
tableOrga.push([3,59,28,[]])
tableOrga.push([3,60,29,[5,"Stratum",30]])
tableOrga.push([3,61,30,[]])
tableOrga.push([3,62,31,[5,"Stratum",30]])
tableOrga.push([3,63,32,[]])
